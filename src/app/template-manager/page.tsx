...
export default function TemplateManagerPage() {
  ...
  const getTemplateTypeIcon = (type: string) => {
    switch (type) {
      ...
      case 'checklist_template': return (
                ...
                {templates.map(template => (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      <div className="flex items-center justify-center">{getTemplateTypeIcon(template.asset_type)}</div>
            ...
            {selectedTemplate && (
              <div className="space-y-6">
                <div className="flex items-center gap-3 pb-4 border-b border-white/10">
                  <div className="flex items-center justify-center mb-2">{getTemplateTypeIcon(selectedTemplate.asset_type)}</div>
                  <div>
